package uk.co.aegisphere.utility;

public class Constants {

        public static final String NAME_PLACEHOLDER = "{NAME}";
        public static final String EDITION_PLACEHOLDER = "{EDITION}";
        public static final String SEASON_PLACEHOLDER = "{SEASON}";
        public static final String RARITY_PLACEHOLDER = "{RARITY}";
        /** EMPERORS */
        ...
        public static final String FOUNDERS_EDITION = "Founders%20Edition";
        public static final String PREMIUM_EDITION = "Premium%20Edition";
        public static final String BASE_EDITION = "Base%20Edition";
        public static final String COMIC_BOOK_EDITION = "Comic%20Book%20Holder%20Edition";
